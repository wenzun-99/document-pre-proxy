...
echo "5000 is container's port, change if necessary"
echo "   docker run -d --name document-pre-proxy-clientName -e PAPERLESS_UPSTREAM="http://someIP" -e PORT="5000" -p someServerPort:5000 ghcr.io/$GITHUB_USERNAME/$IMAGE_NAME:$IMAGE_TAG"
